...
namespace Internal.Core.Audio
{
    public static class Synthesizer
    {
...
#if UNITY_EDITOR
                string.Format("Internal.Core.Audio.Source #{0:X2}", sourceIndex++)
#endif
            );
        ...
        public static bool IsKeyedOn(uint handle)
        {
            if (handle == 0)
            {
                Debug.LogErrorFormat("Internal.Core.Audio.Synthesizer IsKeyedOn: bad handle");
                return false;
            }
            ...
            float modVolume = 1f)
        {
            if (c == null)
            {
                Debug.LogErrorFormat("Internal.Core.Audio.Synthesizer KeyOn: missing audio clip reference");
                return 0;
            }
        ...
        public static void KeyOn(Patch patch, AudioSource src, float delay = 0f, float volume = 1f)
        {
            if (patch == null)
            {
                Debug.LogErrorFormat("Internal.Core.Audio.Synthesizer KeyOn: missing patch reference");
                return;
            }
        ...
        public static void KeyOff(uint handle, float release = 0f, EnvelopeMode mode = EnvelopeMode.None)
        {
            if (handle == 0)
            {
                Debug.LogErrorFormat("Internal.Core.Audio.Synthesizer KeyOff: bad handle");
                return;
            }
        ...
        internal static void SetModVolume(uint handle, float volume)
        {
            if (handle == 0)
            {
                Debug.LogErrorFormat("Internal.Core.Audio.Synthesizer SetModVolume: bad handle");
                return;
            }
        ...
        public static void Stop(uint handle)
        {
            if (handle == 0)
            {
                Debug.LogErrorFormat("Internal.Core.Audio.Synthesizer Stop: bad handle");
                return;
            }
