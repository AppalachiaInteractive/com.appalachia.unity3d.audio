...
namespace Appalachia.Audio
{
    public static class GAC
    {
        ...
        public static float THRESHOLD_LINEAR_LOW =
            20.0f * Mathf.Pow(10.0f, THRESHOLD_DB_LOW * 0.05f);
        ...
        public static float Lookup(AudioMixer mixer, string property)
        {
            ...
            throw new NotSupportedException(
                $"Mixer [{mixer.name}] does not have property [{property}]."
            );
        }
        ...
        [DllImport("AudioPluginDemo")]
        private static extern void ChannelMonitor_GetCorrelation(
            int index,
            int numsamples,
            float[] data);
        ...
        public static float dBToNormalized(
            float dB,
            float oldMin = THRESHOLD_DB_LOW,
            float oldMax = THRESHOLD_DB_HIGH,
            float newMin = 0.0f,
            float newMax = 1.0f,
            bool clamp = true)
        {
        ...
        public static class WIND
        {
            ...
            public const string _GUST_CHANNEL_MONITOR_INSTANCE_HIGH =
                "_WIND_GUST_CHANNEL_MONITOR_INSTANCE_HIGH";

            public const string _GUST_CHANNEL_MONITOR_INSTANCE_MID =
                "_WIND_GUST_CHANNEL_MONITOR_INSTANCE_MID";

            public const string _GUST_CHANNEL_MONITOR_INSTANCE_LOW =
                "_WIND_GUST_CHANNEL_MONITOR_INSTANCE_LOW";
        }
    }
}
